...
HOST = '192.168.1.111'    # Server(Raspberry Pi) IP address
PORT = 21567
...
top.bind('<KeyRelease-Left>', x_decrease)
top.bind('<KeyRelease-Right>', x_increase)
top.bind('<KeyRelease-Up>', y_increase)
top.bind('<KeyRelease-Down>', y_decrease )
